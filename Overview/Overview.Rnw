...
\begin{quotation}
Multi-gigabyte data sets challenge and frustrate \proglang{R}
users, even on well-equipped hardware.
Use of \proglang{C/C++} can provide efficiencies,
...
> summary(x)
                          min        max        mean        NA's
Year                     1987       2008        1998           0
Month                       1         12     6.48309           0
DayofMonth                  1         31    15.72129           0
DayOfWeek                   1          7     3.94140           0
ArrDelay                -1437       2598     6.89996     2502926
DepDelay                -1410       2601     7.97715     2230332
...
elegant framework for users to manage and explore large data sets.
...
The progamming interface is stable, and offers the flexibility to support
the development of
...
> for (i in allplanes) {
+   planeStart[i] <- birthmonth( x[mwhich(y, 'TailNum', i, 'eq'),
...
Age          0.0141  0.0139  0.0143 0.0001 0
Year         0.0437  0.0457  0.0417 0.0010 0
\end{Soutput}
\end{Schunk}
From this, we might conclude that older planes are associated with increased predicted
delays, and predicted delays in recent years are higher than 10-20 years ago.  However,
